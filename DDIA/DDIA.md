...
[Part 1. Data Structures That Power Your Database]{.underline}
...
-   Log file - bash scripting a kv store
    ...
    -   Db_get -- poor performance since scans entire file, cost O(n)

    -   Db_set -- good performance since appends
...
-   Merging
    ...
    -   "we can also merge several segments together at the same time as
        ...
        the new merged segment instead of the old segments---and then
        the old segment files can simply be deleted."
...
generated](media/image1.png){width="6.5in" height="3.9875in"}
...
[Part 2. Transaction Processing or Analytics?]{.underline}
...
generated](media/image3.png){width="6.5in" height="2.223611111111111in"}
...
generated](media/image4.png){width="4.671345144356955in"
height="3.460087489063867in"}
...
generated](media/image5.png){width="5.638888888888889in" height="1.5in"}
...
![A computer code with blue text Description automatically
generated](media/image7.png){width="5.185867235345582in"
height="1.4371916010498689in"}

![A white background with black text and blue and orange numbers
Description automatically generated](media/image8.png){width="6.5in"
...
![A screenshot of a computer Description automatically
generated](media/image9.png){width="6.5in" height="5.151388888888889in"}
...
![](media/image13.png){width="6.5in" height="4.608333333333333in"}
